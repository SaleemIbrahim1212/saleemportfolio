...
<div className=' relative w-full bg-transparent flex flex-col justify-between self-center'>
    ...
    <nav>
      <ul className='flex space-x-4'>
        ...
        <Link   href = "#Experience_Section" className=' scroll-smooth'>  <li className='hover:text-blue-400 cursor-pointer text-lg'>Experience</li> </Link> 
        <Link href = "#Projects_Section" className=' scroll-smooth'> <li className='hover:text-blue-400 cursor-pointer text-lg'>Projects</li> </Link> 
        <Link href = "#Message_Form" className=' scroll-smooth'>  <li className='hover:text-blue-400 cursor-pointer text-lg'>Contact Me</li> </Link> 
      </ul>
    </nav>
  ...
  <Link href='https://github.com/saleemibrahim1212' target='_blank'> <li> <FaGithubAlt size={30}/></li></Link> 
    <Link href="https://www.linkedin.com/in/saleem-ibrahim-0162a8121/" target='_blank' >  <li> <AiFillLinkedin size={30}/></li></Link>
    </ul>
    </div>
...
<Link href='#About_Section' className='font-sans ml-3 mb-10'> Scroll down</Link>
