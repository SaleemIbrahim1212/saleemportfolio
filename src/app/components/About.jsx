  ...
  return (
    <div className='relative bg-white flex justify-center p-4 m-0 ml-0 mr-0 mb-0'>
      ...
      <div id="About_Section" className='flex flex-col'>
        ...
        <span className='text-black text-center text-lg font-semibold mt-5'>
          I am a recent computer science and psychology graduate at Wilfrid Laurier University with a passion for solving problems
        </span>
        <span className='text-black text-center text-lg font-semibold mt-2'>
        ...
        <div className='w-full grid  sm:grid lg:grid-cols-2 sm:grid-cols-1 m-10 h-full'>
          <div className='flex-col lg:m-6 lg:ml-0 p-6 self-center mt-4 w-full flex flex-wrap right-0'>
            ...
            <p className='text-black text-center mt-4 '> One of my main interests is in machine learning and artificial intelligence, and I recently completed a <span className='text-red-300'> machine learning specialization </span> at Coursera and am currently seeking to complete the amazing Deep Learning Specialization there!
            </p>
            <p className='text-black text-center mt-4 '> Besides these, I often enjoy going for runs. I have been doing so for the past 2 years now. I also like watching soccer; my favorite team to watch every weekend is Chelsea. I also love books, <span className='text-blue-500'>here are some books I have read so far</span>
            </p>
          </div>
        ...
        <div className='grid lg:grid-cols-2 sm:grid-cols-1 w-full self-center'>
          <button className='font-bold ml-14 lg:mb-0 sm:mb-5 self-center bg-black text-white w-11/12 h-16'> Download My Resume! </button>
