...
<button className='bg-black text-white ml-14 mt-6  w-4/5 h-16'> Download My Resume </button>
</div>

<div className='flex flex-col mt-14  w-4/6'> 
...
<div class="w-full bg-gray-600 rounded-full h-2.5 dark:bg-gray-700">
  ...
  <button className=' font-bold ml-14 self-center bg-gray-200 text-black w-4/5 mt-8 h-16'> Send Me a Message! </button>
