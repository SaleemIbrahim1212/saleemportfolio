...
<ol className="relative border-l border-gray-200 dark:border-gray-700 md:ml-9 md:mr-11 md:w-1/2 m-0 mt-5">                  
    ...
    <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -left-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
        <p className="mb-1 text-sm leading-none text-gray-400 dark:text-gray-500 font-bold">Product Analyst</p>
        <h3 className="text-lg font-semibold text-white ">Details available upon request</h3>
